...
La résolution du problème complémentaire \@ref(eq:xaxcomp) se fait en trouvant d'abord un $x$ dans l'ensemble de faisabilité, par exemple avec la méthode proposée dans la section \@ref(proj), puis en mettant à jour coordonnée par coordonné jusqu'à convergence.
